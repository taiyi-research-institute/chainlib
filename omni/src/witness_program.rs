...
//! WitnessProgram
//!
//! This module contains the representation of a Omni witness program and utility functions
...
impl WitnessProgram {
    ...
    pub fn new(program: &[u8]) -> Result<Self, WitnessProgramError> {
        ...
        // https://github.com/omni/bips/blob/master/bip-0173.mediawiki#Decoding
    ...
    pub fn validate(&self) -> Result<(), WitnessProgramError> {
        ...
        // https://omnicore.org/en/segwit_wallet_dev/#creation-of-p2sh-p2wpkh-address
