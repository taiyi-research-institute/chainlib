use chainlib_core::{libsecp256k1, PublicKey,PublicKeyError, Address, AddressError};
use crate::{TronAddress,TronFormat,TronPrivateKey};
...
impl PublicKey for TronPublicKey{
    ...
    fn from_private_key(private_key: &Self::PrivateKey) -> Self {
        Self(libsecp256k1::PublicKey::from_secret_key(&private_key.to_secp256k1_secret_key()))
    }
